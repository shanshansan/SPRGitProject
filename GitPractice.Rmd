...
As a group, pick one or two of the following questions to explore. Each question has at least 2 sub-questions. 
...
big_bois <- heroes %>%
  ...
  filter(!(Publisher=="DC Comics" & name=="Captain Marvel"))
